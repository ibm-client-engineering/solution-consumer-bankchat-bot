...
async function createconfig() {
  ...
  const config = {
    ...
    baseUrl: '/solution-consumer-bankchat-bot/',


    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: 'ibm-client-engineering', // Usually your GitHub org/user name.
    projectName: 'solution-consumer-bankchat-bot', // Usually your repo name.
      ...
      [
        ...
        ({
          docs: {
            ...
            editUrl:
              'https://github.com/ibm-client-engineering/solution-consumer-bankchat-bot/tree/main/packages/create-docusaurus/templates/shared/',
          },
          theme: {
          ...
          blog: {
            ...
            editUrl: ({ locale, blogDirPath, blogPath, permalink }) =>
              `https://github.com/ibm-client-engineering/solution-consumer-bankchat-bot/edit/main/${blogDirPath}/${blogPath}`,
      ...
      ({
        ...
        navbar: {
          ...
          items: [
            ...
            {
              href: 'https://github.com/ibm-client-engineering/solution-consumer-bankchat-bot',
